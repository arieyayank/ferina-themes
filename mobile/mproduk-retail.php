<div class="theclear">
	<h1 class="page-title"><?php echo __('Retail Product','Ferina');?></h1>
</div>
<div class="wrap-pages">
	...
	<?php 
		...
		$args = array( 'post_type' => 'produk_retail', 'posts_per_page' => 6, 'paged' => $paged  );
		...
		<?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
			<div class="mkotak-product produk-archive">
				<div class="kotak-inner">
					...
					<p>
						<?php echo currency(get_post_meta($post->ID, 'mtb_harga_satuan_retail', true)); ?>
					</p>
