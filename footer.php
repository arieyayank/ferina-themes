		...
		<div class="tools-ferina">
			<div class="container">
				<div class="fe-box">
					<span>
						<img src="<?php bloginfo('template_url');?>/asset/img/savesecure.png" alt="ferina">
					</span>
					<span>
				...
				<div class="fe-box">
					<span>
						<img src="<?php bloginfo('template_url');?>/asset/img/phonegray.png" alt="<?php _e('Support', 'ferina');?>">
					</span>
					<span>
				...
				<div class="fe-box">
					<span>
						<img src="<?php bloginfo('template_url');?>/asset/img/cargray.png" alt="<?php _e('Ship Worldwide', 'ferina');?>">
					</span>
					<span>
		...
		<div class="widgetbottom theclear">
			<div class="container">
				<div class="bottombox">
					...
					<?php else :?>
					<img alt="<?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/logobawah.png">
					<?php endif ;?>
				</div>
				<div class="bottombox">
					<strong><?php _e('Find Us at', 'ferina');?> : </strong>
						<ul>
							...
							<li><a title="Whatsapp <?php bloginfo('name');?>" class="tipshow" href="#" title="<?php echo get_option('whatsapp_num');?>"><img alt="Whatsapp <?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/whatsapp.png"></a></li>
							<?php }?>
							<?php if (get_option('yahoo_id') != ''){?>
							<li><a title="Yahoo <?php bloginfo('name');?>" class="tipshow" href="#" title="<?php echo get_option('yahoo_id');?>"><img alt="Yahoo <?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/yahoo.png"></a></li>
							<?php }?>
							<?php if (get_option('twitter_user')){?>
							<li><a target="blank" title="Twitter <?php bloginfo('name');?>" class="tipshow" href="<?php echo get_option('twitter_user');?>" title="Twitter"><img alt="Twitter <?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/twitter.png"></a></li>
							<?php }?>
							<?php if (get_option('facebook_url')){?>
							<li><a target="blank" title="Facebook <?php bloginfo('name');?>" class="tipshow" href="<?php echo get_option('facebook_url');?>" title="Facebook Profil"><img alt="Facebook <?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/facebook.png"></a></li>
							<?php } ?>
							<?php if(get_option('instagram_user')){?>
							<li><a target="blank" title="<?php bloginfo('name');?> @instagram" class="tipshow" href="#" title="<?php echo get_option('instagram_user');?>"><img alt="<?php bloginfo('name');?> @instagram" src="<?php bloginfo('template_url');?>/asset/img/instagram.png"></a></li>
							<?php } ?>
							<?php if(get_option('pin_bbm')){?>
							<li><a title="Pin BB <?php bloginfo('name');?>" class="tipshow" href=""><?php get_option('pin_bbm'); ?><img alt="Pin BB <?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/bbm.png"></a></li>
							<?php } ?>
						</ul>
				</div>
			</div>
		...
		<div class="footer">
			<div class="container">
				...
				<div class="delivery-icon">
					<img alt="<?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/jne-logo.jpg">
					<img alt="<?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/eslexpres.jpg">
					<img alt="<?php bloginfo('name');?>" src="<?php bloginfo('template_url');?>/asset/img/pandu.jpg">
				</div>
			</div>
		</div>
		
		<script src="<?php bloginfo('template_url');?>/asset/js/jquery.min.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/responsiveslides.min.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/jquery-ui.min.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/jquery.tooltip.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/jquery.jqzoom-core.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/jquery.carouFredSel-6.1.0-packed.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/fliplightbox.min.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/main.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/ajax.js"></script>
		
		<?php if ( wp_is_mobile() ): ?>
		
		<script src="<?php bloginfo('template_url');?>/asset/js/jquery.slicknav.min.js"></script>
		<script src="<?php bloginfo('template_url');?>/asset/js/mobile-main.js"></script>
		<?php endif; ?>
